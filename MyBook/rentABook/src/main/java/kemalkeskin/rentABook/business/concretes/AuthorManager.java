...
public class AuthorManager implements AuthorService {
	...
	public GetByIdAuthorResponse getById(int id) {
		...
		GetByIdAuthorResponse getByIdAuthorResponse = modelMapperService.forResponse().map(author,
				GetByIdAuthorResponse.class);
	...
	public void update(UpdateAuthorRequest updateAuthorRequest) {
			Optional<Author> authorId=authorRepository.findById(updateAuthorRequest.getId());
